package com.maogu.htclibrary.widget.wheelview;
...
import com.maogu.htclibrary.widget.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawShadows(Canvas canvas) {
        int size = getVisibleItems();
        int height = size / 2 * getItemHeight() + ITEM_OFFSET_PERCENT;

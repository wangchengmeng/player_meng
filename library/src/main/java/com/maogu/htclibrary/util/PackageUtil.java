...
public class PackageUtil {
    ...
    public static String getDeviceId() {
        String deviceId;
        deviceId = ((TelephonyManager) HtcApplicationBase.getInstance().getSystemService(Context.TELEPHONY_SERVICE))
                .getDeviceId();
        if (StringUtil.isNullOrEmpty(deviceId)) {
            deviceId = Secure.getString(HtcApplicationBase.getInstance().getContentResolver(), Secure.ANDROID_ID);
        }
        return deviceId;
    }
    ...
    public static String getApplicationName() {
        ...
        try {
            packageManager = HtcApplicationBase.getInstance().getBaseContext().getPackageManager();
